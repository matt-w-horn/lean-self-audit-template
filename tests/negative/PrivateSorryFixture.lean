...
`_private.<Module>.<n>.Template.NegativeFixtures.privateSorryProbe` — a name
...
private theorem Template.NegativeFixtures.privateSorryProbe : 3 + 3 = 6 := by sorry
