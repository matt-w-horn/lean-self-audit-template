#!/usr/bin/env python3
"""Prose-side checks for the Template library. Invoked by the test driver
(`lake exe templateTest`, stage 6). The proof-token scanner reads source
...
lean_files = sorted((root / "Template").glob("**/*.lean"))
